...
def get_model(vocab, embed_dim, hidden_dim, num_layers):
    num_classes = 6
    rnn_model = LSTM(len(vocab), embed_dim=embed_dim, hidden_dim=hidden_dim, num_layers=num_layers, num_classes=num_classes)
    return rnn_model
...
if __name__ == '__main__':
    ...
    rnn_model = LSTM(len(vocab), EMBED_DIM, hidden_dim=32, num_layers=NUM_LAYERS, num_classes=num_classes)
